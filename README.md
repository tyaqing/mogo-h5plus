...
| ------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------ |-|-|
| ![](https://oivkbuqoc.qnssl.com/6372e21930942ece61b5f24a48e87e7ab0e45c70?attname=blob&tmp=1554385208.7800162) | ![](https://oivkbuqoc.qnssl.com/52480f530ebf8e36e9491682069bd64742f63586?attname=blob&tmp=1554385208.780548) |![](https://pp.myapp.com/ma_icon/0/icon_52854708_1553753611/96)||
...
MogoH5+ 是一个面向 HBuilder/H5+ 与 Vue 2 生态的历史项目。2026 年开始重新整理维护工作，当前重点是:

- 梳理旧版 Vue/Webpack/HBuilder 依赖的安全风险
- 补充维护、贡献和安全报告流程
- 保留现有用户可参考的文档与示例
- 逐步整理迁移建议，而不是一次性破坏旧项目兼容性

如果你仍在使用本项目，欢迎通过 Issue 提供依赖、构建环境、HBuilder 版本和迁移需求。
